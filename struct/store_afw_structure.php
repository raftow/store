...
class StoreStoreAfwStructure
{
        ...
        public static function initInstance(&$obj)
        {
                if ($obj instanceof Store) {
                        ...
                        $obj->after_save_edit = array("mode" => "qsearch", "currmod" => 'store', "class" => 'Store', "submit" => true);
                } else {
                        StoreArTranslator::initData();
                        StoreEnTranslator::initData();
                }
        }
