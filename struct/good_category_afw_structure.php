...
class StoreGoodCategoryAfwStructure
{
        // token separator = §
        public static function initInstance(&$obj)
        {
                if ($obj instanceof GoodCategory) {
                        ...
                        $obj->after_save_edit = array("mode" => "qsearch", "currmod" => 'store', "class" => 'GoodCategory', "submit" => true);
                } else {
                        GoodCategoryArTranslator::initData();
                        GoodCategoryEnTranslator::initData();
                }
        }
