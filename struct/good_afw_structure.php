...
class StoreGoodAfwStructure
{
	...
	public static function initInstance(&$obj)
	{
		if ($obj instanceof Good) {
			...
			$obj->after_save_edit = array("mode" => "qsearch", "currmod" => 'store', "class" => 'Good', "submit" => true);
		} else {
			GoodArTranslator::initData();
			GoodEnTranslator::initData();
		}
	}
