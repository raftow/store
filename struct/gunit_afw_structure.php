...
class StoreGunitAfwStructure
{
        ...
        public static function initInstance(&$obj)
        {
                if ($obj instanceof Gunit) {
                        ...
                        $obj->after_save_edit = array("mode" => "qsearch", "currmod" => 'store', "class" => 'Gunit', "submit" => true);
                } else {
                        GunitArTranslator::initData();
                        GunitEnTranslator::initData();
                }
        }
