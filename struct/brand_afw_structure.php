...
class StoreBrandAfwStructure
{
        ...
        public static function initInstance(&$obj)
        {
                if ($obj instanceof Brand) {
                        ...
                        $obj->after_save_edit = array("mode" => "qsearch", "currmod" => 'store', "class" => 'Brand', "submit" => true);
                } else {
                        BrandArTranslator::initData();
                        BrandEnTranslator::initData();
                }
        }
