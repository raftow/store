...
class StoreObject extends AfwMomkenObject{
        ...
        */
        ...
        public static function code_of_stock_operation_enum($lkp_id=null)
        {
            ...
            if($lkp_id) return self::stock_operation()['code'][$lkp_id];
            else return self::stock_operation()['code'];
        }
        ...
        {
            $lang = AfwLanguageHelper::getGlobalLanguage();
            if($lkp_id) return self::newold()['code'][$lkp_id];
            else return self::newold()['code'];
        }
        ...
        {
            $lang = AfwLanguageHelper::getGlobalLanguage();
            if($lkp_id) return self::stock_sens()['code'][$lkp_id];
            else return self::stock_sens()['code'];
        }
