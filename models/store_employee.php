...
class StoreEmployee extends StoreObject
{
        ...
        {
                if (!$orgunit_id) $orgunit_id = StoreEmployee::orgOfEmployee($employee_id, false, true);

                if ($orgunit_id > 0) return StoreEmployee::checkExistance($orgunit_id, $employee_id);
                else return null;
        }
        ...
        {
                if (!$this->getVal("orgunit_id")) return ($what == "value") ? 0 : null;
